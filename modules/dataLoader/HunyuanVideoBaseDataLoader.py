...
class HunyuanVideoBaseDataLoader(
    ...
    def _preparation_modules(self, config: TrainConfig, model: HunyuanVideoModel):
        ...
        tokenize_prompt_1 = Tokenize(in_name='prompt_1', tokens_out_name='tokens_1', mask_out_name='tokens_mask_1', tokenizer=model.tokenizer_1, max_token_length=1024, format_text=DEFAULT_PROMPT_TEMPLATE, additional_format_text_tokens=DEFAULT_PROMPT_TEMPLATE_CROP_START)
